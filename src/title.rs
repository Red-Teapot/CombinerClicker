...
use crate::assets::*;
use crate::{GameState, palette};

const FADE_OUT_TIME: f32 = 0.2;

pub fn startup_title(mut commands: Commands, ui_assets: Res<GameAssets>) {
...
pub fn handle_title_click(mut commands: Commands,
                          ...
                          time: Res<Time>) {
    if buttons.just_pressed(MouseButton::Left) && fade_out.is_none() {
